...
<div class="flex-grow h-full flex flex-wrap overflow-y-auto relative">
    <div class="w-full md:w-96 h-full flex flex-col overflow-hidden select-none border-r border-gray-200">
        <div class="w-full h-16 flex justify-center items-center my-2 border-b border-gray-100">
        ...
        <div class="w-full flex-grow" ref="noteContainer">
            <div class="w-full overflow-y-auto no-scrollbar" :style="{ height: height }">
                <div class="flex flex-col my-4 mx-8">
                    <div class="group flex items-center w-full h-24 shadow-sm hover:shadow hover:cursor-pointer md:px-2 border-x-4 border-y-8 border-slate-50"
