...
onMounted(() => {
    height.value = msgContainer.value.offsetHeight + "px"
})
</script>
            ...
            <div class="w-5/6 flex mx-auto">
                <div class="opacity-60 my-1.5 flex-1 text-sm">
                    ...
                    <select class="outline-none border-none font-bold text-center">
                        <option value>最新消息优先</option>
                        <option value>最后消息优先</option>
                    </select>
                </div>
                <div class="opacity-50 text-sm">
                    创建会话
                    <div class="inline-block item-center">
                        <img class="h-8 inline-block shadow" src="/src/assets/img/加号.svg" />
                    </div>
                </div>
            </div>
            <div class="w-full h-full flex-grow bg-gray-50" ref="msgContainer">
                        ...
                        >
                                ...
                                <div class="flex flex-col flex-grow h-16 pl-2 pr-3">
                                    <div class="flex h-full flex-row">
                                        ...
                                        <div class="font-light text-sm opacity-70 group-hover:opacity-90 flex items-center flex-grow flex-row-reverse">
                                            3小时之前
                                        </div>
                                    </div>
                                </div>
