<script setup>
	...
	// 异步组件加载
	const Register = defineAsyncComponent(() => import("../login/components/Register.vue"));
	const ForgetPasswd = defineAsyncComponent(() => import("../login/components/ForgetPasswd.vue"));
		...
		>
			...
			>
				...
				<div class="w-full max-w-md z-10">
					<div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6 select-none">
						欢迎光临
					</div>
